...
/*     textGeo = new THREE.PlaneGeometry(300,300);
    ...
    smokeMaterial = new THREE.MeshLambertMaterial({color: 0xF8F8F8, map: smokeTexture, transparent: true});
    ...
    document.getElementById('homeContainer').appendChild( renderer.domElement );
