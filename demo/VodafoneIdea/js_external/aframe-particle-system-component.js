...
/***/ function(module, exports, __webpack_require__) {
	...
	AFRAME.registerComponent('particle-system', {
	    ...
	    init: function() {
            ...
            this.presets['dust-hit'] = {
	            maxAge: (this.data.maxAge!==0?this.data.maxAge:1),
	            positionSpread: (this.data.positionSpread.x!==0||this.data.positionSpread.y!==0||this.data.positionSpread.z!==0?this.data.positionSpread:{x:1,y:1,z:1}),
	            type: (this.data.type!==0?this.data.type:SPE.distributions.SPHERE), /* SPE.distributions.SPHERE, SPE.distributions.DISC */
	            rotationAxis: (this.data.rotationAxis!==''?this.data.rotationAxis:'x'),
	            ...
	            accelerationSpread: (this.data.accelerationSpread.x!==0||this.data.accelerationSpread.y!==0||this.data.accelerationSpread.z!==0?this.data.accelerationSpread:{x: 0, y: -1, z: 0}),
	            velocityValue: (this.data.velocityValue.x!==0||this.data.velocityValue.y!==0||this.data.velocityValue.z!==0?this.data.velocityValue:{x: 0, y: 0, z: 0}),
	            velocitySpread: (this.data.velocitySpread.x!==0||this.data.velocitySpread.y!==0||this.data.velocitySpread.z!==0?this.data.velocitySpread:{x: 0, y: 0, z: 0}),
	            color: (this.data.color.length?this.data.color:['#EDC9AF']),
	            size: (this.data.size!==0?this.data.size:[5,25]),
	            opacity: { value: (this.data.opacity!=0?this.data.opacity:[1,0.3]) },
	            direction: (this.data.direction!==0?this.data.direction:-1),
	            duration: (this.data.duration!=0?this.data.duration:1),
                blending: this.data.blending = 0,
	            particleCount: (this.data.particleCount!==0?this.data.particleCount:12),
	            texture: (this.data.texture!==''?this.data.texture:'img/cloud.png'),
	            randomize: false
	        };            
           
            this.presets['smoke-hit'] = {
	            maxAge: (this.data.maxAge!==0?this.data.maxAge:0.5),
	            positionSpread: (this.data.positionSpread.x!==0||this.data.positionSpread.y!==0||this.data.positionSpread.z!==0?this.data.positionSpread:{x:3,y:3,z:3}),
	            type: (this.data.type!==0?this.data.type:SPE.distributions.SPHERE), /* SPE.distributions.SPHERE, SPE.distributions.DISC */
	            rotationAxis: (this.data.rotationAxis!==''?this.data.rotationAxis:'x'),
	            rotationAngle: (this.data.rotationAngle!==0?this.data.rotationAngle:3.14),
	            accelerationValue: (this.data.accelerationValue.x!==0||this.data.accelerationValue.y!==0||this.data.accelerationValue.z!==0?this.data.accelerationValue:{x: 0, y: 0, z: 0}),
	            ...
	            velocityValue: (this.data.velocityValue.x!==0||this.data.velocityValue.y!==0||this.data.velocityValue.z!==0?this.data.velocityValue:{x: 0, y: 0, z: 0}),
	            velocitySpread: (this.data.velocitySpread.x!==0||this.data.velocitySpread.y!==0||this.data.velocitySpread.z!==0?this.data.velocitySpread:{x: 0, y: 0, z: 0}),
	            color: (this.data.color.length?this.data.color:['#999999']),
	            size: (this.data.size!==0?this.data.size:[1,15]),
	            opacity: { value: (this.data.opacity!=0?this.data.opacity:[1,0.3]) },
	            direction: (this.data.direction!==0?this.data.direction:-1),
	            duration: (this.data.duration!=0?this.data.duration:1),
                blending: this.data.blending = 1,
	            particleCount: (this.data.particleCount!==0?this.data.particleCount:35),
	            texture: (this.data.texture!==''?this.data.texture:'img/cloud.png'),
	            randomize: false
	        };

	        this.presets['money-rain'] = {
	            maxAge: (this.data.maxAge!==0?this.data.maxAge:3),
	            positionSpread: (this.data.positionSpread.x!==0||this.data.positionSpread.y!==0||this.data.positionSpread.z!==0?this.data.positionSpread:{x:10,y:1,z:10}),
	            type: (this.data.type!==0?this.data.type:SPE.distributions.DISC), /* SPE.distributions.SPHERE, SPE.distributions.DISC */
	            rotationAxis: (this.data.rotationAxis!==''?this.data.rotationAxis:'z'),
	            rotationAngle: (this.data.rotationAngle!==0?this.data.rotationAngle:3.14),
	            accelerationValue: (this.data.accelerationValue.x!==0||this.data.accelerationValue.y!==0||this.data.accelerationValue.z!==0?this.data.accelerationValue:{x: 0, y: 0.1, z: 0}),
	            ...
	            velocityValue: (this.data.velocityValue.x!==0||this.data.velocityValue.y!==0||this.data.velocityValue.z!==0?this.data.velocityValue:{x: 0, y: 3, z: 0}),
	            velocitySpread: (this.data.velocitySpread.x!==0||this.data.velocitySpread.y!==0||this.data.velocitySpread.z!==0?this.data.velocitySpread:{x: 3, y: 0, z: 0}),
	            color: (this.data.color.length?this.data.color:['#FFFFFF']),
	            size: (this.data.size!==0?this.data.size:6),
	            opacity: { value: (this.data.opacity!=0?this.data.opacity:[1,1]) },
	            angle: (this.data.angle!==0?this.data.angle:1),
	            direction: (this.data.direction!==0?this.data.direction:1),
	            duration: (this.data.duration!=0?this.data.duration:null),
	            blending: this.data.blending = 1,
	            particleCount: (this.data.particleCount!==0?this.data.particleCount:50),
	            texture: (this.data.texture!==''?this.data.texture:'img/dollarRain.png'),
	            randomize: false
	        };
